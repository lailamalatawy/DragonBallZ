...
public class NewGamePanel extends JPanel{
	...
	JLabel newgameTitle;
	JLabel pickplayer;
	JLabel enterPlayerName;
	JLabel enterFighterName;
	JLabel characters;
	JTextFieldLimit playerNameField;
	...
	public NewGamePanel(final Main mainFrame){
		setSize(1250,700);
		setLayout(null);
		...
		newgameTitle = new JLabel(new ImageIcon("newgame3.png"));
		newgameTitle.setBounds(50, 50, 541, 96);
		...
		enterPlayerName = new JLabel(new ImageIcon("enternamefinal.png"));
		enterPlayerName.setBounds(80, 420, 628, 63);
		enterPlayerName.setBorder(BorderFactory.createEmptyBorder());
		//logo.setContentAreaFilled(false);
		...
		playerTitle.setBounds(750, 530, 200, 60);
		playerTitle.setBorder(BorderFactory.createEmptyBorder());


		playerNameTyped = new JLabel("PlayerName");
		playerNameTyped.setBounds(950, 535, 300, 53);
		playerNameTyped.setFont(f);
		
		
		fighterTitle = new JLabel(new ImageIcon("fighter2.png"));
		fighterTitle.setBounds(750, 590, 200, 60);
		fighterTitle.setBorder(BorderFactory.createEmptyBorder());


		fighterNameTyped = new JLabel("FighterName");
		fighterNameTyped.setBounds(950, 595, 300, 53);
		fighterNameTyped.setFont(f);

		
		
		playerNameField = new JTextFieldLimit(11);
		playerNameField.setHorizontalAlignment(JTextFieldLimit.CENTER);
		playerNameField.setBounds(90, 490, 400, 60);
		Border roundedBorder = new LineBorder(Color.black, 1, false);
		playerNameField.setBorder(roundedBorder);
		playerNameField.setText("Player Name");
		playerNameField.setFont(f);
		playerNameField.setForeground(Color.BLACK);
		playerNameField.getDocument().addDocumentListener(new MyDocumentListener(playerNameTyped));



		fighterNameField = new JTextFieldLimit(11);
		...
		okPLayerName = new JButton("OK");
		okPLayerName.setBounds(256, 550, 70, 70);
		//ok.setBackground(Color.MAGENTA);
		okPLayerName.addMouseListener(new  MouseListener() {
		...
		doneFighterName.addMouseListener(new  MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				mainFrame.dispose();
				try {
					WorldFrame worldFrame = new WorldFrame(game);
